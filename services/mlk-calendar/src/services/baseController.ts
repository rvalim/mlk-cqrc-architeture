...
export default abstract class BaseController<T> {
  ...
  public abstract async createFromBroker?(body: object): Promise<void>;
  ...
  public abstract async getByRange?(req: Request, res: Response, next: NextFunction): Promise<void>;
  public abstract async getByDate?(req: Request, res: Response, next: NextFunction): Promise<void>;
